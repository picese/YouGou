...
// 添加品牌
Category.addSecondCategory = function (brand, callback) {
...
// 删除商品
Category.deleteTopCategory = function (id,callback) {
  var delSql = "UPDATE category SET isDelete =0 WHERE id = " + id;
