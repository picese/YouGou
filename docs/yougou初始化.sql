...
MySQL - 5.5.20-log : Database - YouGou
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`YouGou` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `address`(`id`,`userId`,`address`,`addressDetail`,`isDelete`,`recipients`,`postCode`,`mobile`) values (1,1,'广东省梅州市梅县区','XX路XX号',1,'张三','111112',NULL);
...
insert  into `brand`(`id`,`brandName`,`categoryId`,`brandLogo`,`isDelete`,`hot`) values (1,'耐克',1,'/M/images/brand1.png',1,1),(2,'阿迪',1,'/M/images/brand2.png',1,1),(3,'新百伦',1,'/M/images/brand4.png',1,1),(4,'三叶草',1,'/M/images/brand3.png',1,0),(5,'匡威',1,'/M/images/brand5.png',1,1),(6,'阿萨德1',2,'/M/images/brand5.png',1,1),(7,'阿萨德2',2,'/M/images/brand5.png',1,1);
